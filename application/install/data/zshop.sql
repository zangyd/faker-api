...
(522, 0, '云端', '', 'yun', '/cloud', 'admin', 0, 'https://www.Faker.cn/', '', '_blank', 1, 11, 1),
...
(1035, 1033, 'Faker(本地上传)', '', '', '', 'admin', 0, '/setting/setting/system/upload/Faker', '', '_self', 0, 50, 1),
...
(1086, 711, '商业授权', '', 'Faker', '商业授权信息查询', 'admin', 0, '/setting/app/authorize', '', '_self', 1, 50, 1),
...
(4, 'success', 'http://www.Faker.cn/', 'payment', '支付成功提示页', '支付成功后返回到的页面'),
(5, 'error', 'http://www.Faker.cn/', 'payment', '支付失败提示页', '支付失败后返回到的页面'),
...
(40, 'description', 'Faker（简称CS）是一套基于ThinkPHP5框架开发的高性能商城框架系统，秉承简洁、快速、极致的开发理念，对内使用面向对象模块化调用，多终端、跨平台采用REST API构架来面向移动网络趋势，可直接对接PC、移动设备、小程序、云部署，构建Android、IOS的APP。', 'system_info', '商城描述', '商城描述，将显示在前台顶部欢迎信息等位置'),
(41, 'logo', 'aliyun.oss.Faker.cn/uploads/files/20200330/4dd3960b-486c-4dfb-8c86-0e424ac61c32.png?type=aliyun', 'system_info', '商城LOGO', '默认商城LOGO，通用头部显示，最佳显示尺寸为240*60像素'),
(42, 'square_logo', 'aliyun.oss.Faker.cn/uploads/files/20200403/8b85fe59-7481-48dc-82ef-592d281b7d4b.png?type=aliyun', 'system_info', '方形LOGO', '方形商城LOGO，通用移动端居多，最佳显示尺寸为80*80像素'),
...
(52, 'weixin_url', 'http://www.Faker.cn/', 'system_info', '移动中间页地址', '例如微信中无法访问实际地址，可通过该地址进行跳转'),
...
(54, 'default', 'Faker', 'upload', '默认资源上传模块', '在不指定上传模块时，系统默认启用的上传模块'),
(55, 'oss', 'Faker.cn/oss?url=', 'upload', '资源获取短地址', '可启用短地址获取资源，避免原地址冗长，不必添加地址前缀'),
...
(60, 'Faker_url', '', 'upload', '资源绑定域名别名', 'Faker(本地上传)绑定资源目录域名后，Host路径将变为该值，不必添加地址前缀'),
...
(3, 1, 'level1.png', 'image/png', 'png', 417, '{\"width\":16,\"height\":16}', 'F41831546A34BE42C34343FD92492C67', '会员等级/level1.png', 'aliyun.oss.Faker.cn/会员等级/level1.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923087, 1588923087),
(4, 1, 'level2.png', 'image/png', 'png', 408, '{\"width\":16,\"height\":16}', 'E61AF90BB05B24B06514F8300674BD96', '会员等级/level2.png', 'aliyun.oss.Faker.cn/会员等级/level2.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923087, 1588923087),
(5, 1, 'level3.png', 'image/png', 'png', 406, '{\"width\":16,\"height\":16}', '578C74719EF4D67B7426A2AB3B481173', '会员等级/level3.png', 'aliyun.oss.Faker.cn/会员等级/level3.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923087, 1588923087),
(6, 1, 'level4.png', 'image/png', 'png', 401, '{\"width\":16,\"height\":16}', '8C1D64E3514293AA87E713727965A965', '会员等级/level4.png', 'aliyun.oss.Faker.cn/会员等级/level4.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923087, 1588923087),
(7, 1, 'level5.png', 'image/png', 'png', 686, '{\"width\":16,\"height\":16}', '670A286772BB8571218CE91A881DB004', '会员等级/level5.png', 'aliyun.oss.Faker.cn/会员等级/level5.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923087, 1588923087),
(8, 1, 'level6.png', 'image/png', 'png', 1118, '{\"width\":52,\"height\":16}', '94E46D065664D0FCAC16C36609FD4B5A', '会员等级/level6.png', 'aliyun.oss.Faker.cn/会员等级/level6.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923087, 1588923087),
(9, 2, 'alipay.gif', 'image/gif', 'gif', 3021, '{\"width\":130,\"height\":40}', '09E09591677CDF421EC853CFCAA6B9C3', '支付图标/alipay.gif', 'aliyun.oss.Faker.cn/支付图标/alipay.gif?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(10, 2, 'hdfk.gif', 'image/gif', 'gif', 2120, '{\"width\":130,\"height\":40}', '41993EF1E4FF5CE64F60BD66714A53D3', '支付图标/hdfk.gif', 'aliyun.oss.Faker.cn/支付图标/hdfk.gif?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(11, 2, 'jd.png', 'image/png', 'png', 2113, '{\"width\":86,\"height\":50}', 'B8C109758B5334BDDCDB4FCE71E73554', '支付图标/jd.png', 'aliyun.oss.Faker.cn/支付图标/jd.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(12, 2, 'baidu.png', 'image/png', 'png', 1789, '{\"width\":86,\"height\":50}', 'CC35A174F72A0BDD4C41170194C44426', '支付图标/baidu.png', 'aliyun.oss.Faker.cn/支付图标/baidu.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(13, 2, 'paypal.jpg', 'image/jpeg', 'jpg', 15141, '{\"width\":130,\"height\":37}', '85952C58A935D24EE51CF91429BD5DF3', '支付图标/paypal.jpg', 'aliyun.oss.Faker.cn/支付图标/paypal.jpg?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(14, 2, 'malipay.gif', 'image/gif', 'gif', 14727, '{\"width\":130,\"height\":40}', '66233678DF31634B26F04491A2CE5850', '支付图标/malipay.gif', 'aliyun.oss.Faker.cn/支付图标/malipay.gif?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(15, 2, 'qq.png', 'image/png', 'png', 3627, '{\"width\":86,\"height\":50}', '7B6E41A80BC2E80A9B1BD3A2388EE7ED', '支付图标/qq.png', 'aliyun.oss.Faker.cn/支付图标/qq.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(16, 2, 'weixin.png', 'image/png', 'png', 1712, '{\"width\":86,\"height\":50}', '752F1A30D6A86FF83D329FB031DDC8CC', '支付图标/weixin.png', 'aliyun.oss.Faker.cn/支付图标/weixin.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(17, 2, 'wxpay.png', 'image/png', 'png', 52342, '{\"width\":130,\"height\":35}', 'DD81FAE66BA72F31847260BB00AD3C9C', '支付图标/wxpay.png', 'aliyun.oss.Faker.cn/支付图标/wxpay.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(18, 2, 'xxzf.gif', 'image/gif', 'gif', 2347, '{\"width\":130,\"height\":40}', '3096FBFAF4FD5BA3CAF99C16ED9D17A4', '支付图标/xxzf.gif', 'aliyun.oss.Faker.cn/支付图标/xxzf.gif?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(19, 2, 'wxmpay.png', 'image/png', 'png', 53092, '{\"width\":130,\"height\":35}', '8A4C4B15AE3C3906A58BED143D8B5018', '支付图标/wxmpay.png', 'aliyun.oss.Faker.cn/支付图标/wxmpay.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(20, 2, 'wxh5pay.png', 'image/png', 'png', 53092, '{\"width\":130,\"height\":35}', '8A4C4B15AE3C3906A58BED143D8B5018', '支付图标/wxh5pay.png', 'aliyun.oss.Faker.cn/支付图标/wxh5pay.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(21, 2, 'yezf.gif', 'image/gif', 'gif', 1128, '{\"width\":130,\"height\":40}', 'CE6885A00CB0CD1172E14CEAE2A2854E', '支付图标/yezf.gif', 'aliyun.oss.Faker.cn/支付图标/yezf.gif?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(22, 2, 'yinlian.png', 'image/png', 'png', 3263, '{\"width\":86,\"height\":50}', 'EA74308D5EA06E0B7AB9A68DD06522A6', '支付图标/yinlian.png', 'aliyun.oss.Faker.cn/支付图标/yinlian.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112),
(23, 2, 'zhifubao.png', 'image/png', 'png', 1751, '{\"width\":86,\"height\":50}', '444B8960B1A5205DD3A3F10C7CE96621', '支付图标/zhifubao.png', 'aliyun.oss.Faker.cn/支付图标/zhifubao.png?type=aliyun', 'aliyun', 0, 1, '', 50, 0, 1588923112, 1588923112);
...
(1, '青铜会员', 'https://aliyun.oss.Faker.cn/会员等级/level1.png?type=aliyun', '0.00', 100, '青铜会员'),
(2, '白银会员', 'https://aliyun.oss.Faker.cn/会员等级/level2.png?type=aliyun', '10000.00', 98, '白银会员累计消费满10000，全场享9.8折优惠'),
(3, '黄金会员', 'https://aliyun.oss.Faker.cn/会员等级/level3.png?type=aliyun', '30000.00', 95, '黄金会员累计消费满30000，全场享9.5折优惠'),
(4, '铂金会员', 'https://aliyun.oss.Faker.cn/会员等级/level4.png?type=aliyun', '50000.00', 92, '铂金会员累计消费满50000，全场享9.2折优惠'),
(5, '钻石会员', 'https://aliyun.oss.Faker.cn/会员等级/level5.png?type=aliyun', '100000.00', 90, '钻石会员累计消费满100000，全场享9折优惠'),
(6, '至尊 VIP', 'https://aliyun.oss.Faker.cn/会员等级/level6.png?type=aliyun', '200000.00', 88, '至尊VIP累计消费满200000，全场享8.8折优惠');
